...
pio.write_html(fig, file='template_2023/most_6s.html', auto_open=False, full_html=False, include_plotlyjs='cdn')
...
pio.write_html(fig, file='template_2023/most_4s.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
...
pio.write_html(fig, file='template_2023/bat_sr.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
...
pio.write_html(fig, file='template_2023/most_runs.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
pio.write_html(fig, file='template_2023/most_6s_4s.html', auto_open=False, full_html=False, include_plotlyjs='cdn')
...
# pyo.plot(fig, filename='most_runs.html')
pio.write_html(fig, file='template_2023/_50s.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
# pyo.plot(fig, filename='most_runs.html')
pio.write_html(fig, file='template_2023/_100s.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
yaxis=dict(
        ...
        range=[len(data)-10, len(data)]))
# pyo.plot(fig, filename='most_runs.html')
pio.write_html(fig, file='template_2023/duck.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
# pyo.plot(fig, filename='most_runs.html')
pio.write_html(fig, file='template_2023/partnership.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
pio.write_html(fig, file='template_2023/most_wickets.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
# pyo.plot(fig, filename='most_wickets.html')
pio.write_html(fig, file='template_2023/BWN.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
pio.write_html(fig, file='template_2023/wkt_perc.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
#fig.show()
...
pio.write_html(fig, file='template_2023/most_maidens.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
pio.write_html(fig, file='template_2023/ER.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
# pyo.plot(fig, filename='ER.html')
pio.write_html(fig, file='template_2023/bowl_sr.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
# pyo.plot(fig, filename='ER.html')
pio.write_html(fig, file='template_2023/_4w.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
# pyo.plot(fig, filename='ER.html')
pio.write_html(fig, file='template_2023/_5w.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
# pyo.plot(fig, filename='ER.html')
pio.write_html(fig, file='template_2023/RC.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
# Show the graph
#pyo.iplot(fig)
...
pio.write_html(fig, file='template_2023/catches.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
...
# pyo.plot(fig, filename='most_4s.html')
pio.write_html(fig, file='template_2023/team_points.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
...
# pyo.plot(fig, filename='most_4s.html')
pio.write_html(fig, file='template_2023/mom.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
...
# Save the graph as HTML
pio.write_html(fig, file='template_2023/team_max_score.html', auto_open=False, full_html=False, include_plotlyjs='cdn')
...
# Create the figure object
fig = go.Figure(data=traces, layout=layout)
pio.write_html(fig, file='template_2023//toss_winner_choice.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
...
# Create the figure object
fig = go.Figure(data=traces, layout=layout)
pio.write_html(fig, file='template_2023/team_win_on_game_time.html', auto_open=False,full_html=False,include_plotlyjs='cdn')
